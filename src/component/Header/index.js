                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li className="relative">
                            <Link  to={"/basket"}
                                ...
                                Basket</Link>
                            {
                                basket.length === 0 ? null : <p className="absolute top-[-10px] right-[-18px]
                                text-white w-[20px] h-[20px] bg-red-600 rounded-[50%] flex justify-center items-center">
                                    {basket.length}
                                </p>
                            }
                        </li>
                        <li className="relative">
                            <Link   to={"/favorite"}
                                ...
                                Favorite</Link>
                            {
                                favorite.length === 0 ? null : <p className="absolute top-[-10px] right-[-18px]
                                text-white w-[20px] h-[20px] bg-red-600 rounded-[50%] flex justify-center items-center">
                                    {favorite.length}
                                </p>
                            }
