...
const Product = () => {
   ...
   const dispatch = useDispatch()
    ...
    return (
        <div style={{    background: "linear-gradient(286deg, #efefef,  #009dff )"  }}>
            <div  className="container  bg-no-repeat bg-center bg-cover  flex flex-wrap wrap gap-9 mx-auto w-5/6">
